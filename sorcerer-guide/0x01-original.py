...
def init_argparse() -> argpars.ArgumentParser:
    ...
    parser.add_argument(
            ...
            help="path to filek to process (omit to use imagesnap)"
    )
    parser.add_argument(
...
def snapshot():
    try:
        ...
        raise Exception("""No file specified and imagesnap not available. See 'python asciiart.py
                         --help'
                        """)
